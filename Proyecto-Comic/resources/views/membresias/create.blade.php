...
@section('title', 'Nueva Membresía - Tienda de Cómics')
        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h2 class="card-title mb-0">Crear Nueva Membresía</h2>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" max="100" class="form-control @error('porcentaje_descuento') is-invalid @enderror" id="porcentaje_descuento" name="porcentaje_descuento" value="{{ old('porcentaje_descuento') }}" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" class="form-control @error('puntos_requeridos') is-invalid @enderror" id="puntos_requeridos" name="puntos_requeridos" value="{{ old('puntos_requeridos') }}" required>
